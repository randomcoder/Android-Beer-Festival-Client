package uk.co.randomcoding.android.beerfestival.tests

import uk.co.randomcoding.android.beerfestival._
...
class AndroidTests extends AndroidTestCase {
  def testPackageIsCorrect() {
    assertEquals("uk.co.randomcoding.android.beerfestival", getContext.getPackageName)
  }
}
